...
static RJ_ResultWarn ResourceMaterial_GetByName(ResourceMaterial **retMaterial, StringView name)
{
...
static RJ_ResultWarn ResourceMaterial_AddFromFileIfNew(StringView matFile, StringView resourcePathInResources)
{
...
static RJ_ResultWarn ResourceMesh_Create(ResourceMesh **retMesh, ResourceModel *model, RJ_Size indexCount, ResourceMaterial *material)
{
